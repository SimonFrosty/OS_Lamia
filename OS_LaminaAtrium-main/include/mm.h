...
/* Extract Swap Offset (swap frame number) */
#define PAGING_SWPOFF(x) GETVAL(x, PAGING_PTE_SWPOFF_MASK, PAGING_SWPFPN_OFFSET)
/* Extract Swap Type */
...
#define OVERLAP(x1,x2,y1,y2) ((y1 < x2) && (x1 < y2)) // no equality
